...
privileged aspect CourseDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    InstructorDataOnDemand CourseDataOnDemand.instructorDataOnDemand;
    ...
    public Course CourseDataOnDemand.getNewTransientCourse(int index) {
        ...
        setInstrctor(obj, index);
        setStartdate(obj, index);
        return obj;
    }
    
    public void CourseDataOnDemand.setCourseName(Course obj, int index) {
    ...
    public void CourseDataOnDemand.setInstrctor(Course obj, int index) {
        Instructor instrctor = instructorDataOnDemand.getRandomInstructor();
        obj.setInstrctor(instrctor);
    }
